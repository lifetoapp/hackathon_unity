...
namespace Thirdweb
{
    ...
    public class ERC20 : Routable
    {
        ...
        // READ FUNCTIONS
        public async Task<byte> GetInventory(EvmAddress evmAddress)
        {

            var decimals = await TransactionManager.ThirdwebRead<TokenERC20Contract.GetItemsFunction, TokenERC20Contract.GetItemsOutputDTO>(
                contractAddress,
                new TokenERC20Contract.GetItemsFunction()
            );

        

            return  decimals.ReturnValue1;
        ...
        // WRITE FUNCTIONS
        public async Task<TransactionResult> BuyRegularLootbox()
        {
            var method = System.Reflection.MethodBase.GetCurrentMethod();
            return await TransactionManager.ThirdwebWrite(contractAddress, new TokenERC20Contract.BuyLootBoxFunction() { });
