...
namespace Thirdweb.Examples
{
    ...
    {
        private const string AdressTestERC20 = "0x9243b0F7352526db51e3BF16181D56A339C84fcA";
        private const string AdressLifeHackatonItems = "0x3D229b0b2df5125F0Bf298f13BBf7462083B5688";
        ...
        {
            Debugger.Instance.Log("Request Sent", "Pending confirmation...");
            Contract contract = ThirdwebManager.Instance.SDK.GetContract(AdressLifeHackatonItems);
            var result = await contract.ERC20.BuyRegularLootbox();
            Debugger.Instance.Log("[Claim ERC20] Successful", result.ToString());
        }
